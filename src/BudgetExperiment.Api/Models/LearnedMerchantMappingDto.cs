// <copyright file="LearnedMerchantMappingDto.cs" company="BecauseImClever">
...
public sealed record LearnedMerchantMappingDto
{
    ...
    /// </summary>
    public required string MerchantPattern
    {
        get; init;
    }
    ...
    /// </summary>
    public required int LearnCount
    {
        get; init;
    }
    ...
    /// </summary>
    public required DateTime UpdatedAtUtc
    {
        get; init;
    }
}
