...
namespace BudgetExperiment.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260408035410_AddUserSettingsKakeiboPreferences")]
    partial class AddUserSettingsKakeiboPreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.Kaizen.KaizenGoal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("KaizenGoals", (string)null);
                });

            modelBuilder.Entity("BudgetExperiment.Domain.Reconciliation.DismissedOutlier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DismissedOutliers", (string)null);
                });
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.Settings.UserSettings", b =>
                {
                    ...
                    b.Property<bool>("EnableKaizenMicroGoals")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("HasCompletedKakeiboSetup")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("ShowKakeiboCalendarBadges")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowMonthlyReflectionPrompts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowSpendingHeatmap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
