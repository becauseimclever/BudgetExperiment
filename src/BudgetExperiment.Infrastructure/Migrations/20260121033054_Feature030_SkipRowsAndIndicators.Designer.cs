...
namespace BudgetExperiment.Infrastructure.Migrations
{
    ...
    [Migration("20260121033054_Feature030_SkipRowsAndIndicators")]
    partial class Feature030_SkipRowsAndIndicators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.ReconciliationMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.ChatMessage", b =>
                {
                    b.HasOne("BudgetExperiment.Domain.ChatSession", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.ReconciliationMatch", b =>
                {
                    b.HasOne("BudgetExperiment.Domain.Transaction", null)
                        .WithMany()
