...
namespace BudgetExperiment.Infrastructure.Migrations
{
    ...
    [Migration("20260131232808_Feature039_ManualReconciliationLinking")]
    partial class Feature039_ManualReconciliationLinking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.Import.ImportMapping", b =>
                {
                    ...
                    b.Property<string>("SkipRowsSettings")
                        .IsRequired()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.Recurring.RecurringTransaction", b =>
                {
                    ...
                    b.OwnsMany("BudgetExperiment.Domain.Recurring.ImportPattern", "ImportPatterns", b1 =>
                        {
                    ...
                    b.OwnsOne("BudgetExperiment.Domain.Recurring.RecurrencePattern", "RecurrencePattern", b1 =>
                        {
                            b1.Property<Guid>("RecurringTransactionId")
                                .HasColumnType("uuid");
