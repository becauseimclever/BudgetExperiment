...
public static class RecurringMapper
{
    ...
    public static RecurringTransactionDto ToDto(RecurringTransaction recurring, string accountName, string? version)
    {
        return new RecurringTransactionDto
        {
            ...
            Frequency = recurring.RecurrencePatternValue.Frequency.ToString(),
            Interval = recurring.RecurrencePatternValue.Interval,
            DayOfMonth = recurring.RecurrencePatternValue.DayOfMonth,
            DayOfWeek = recurring.RecurrencePatternValue.DayOfWeek?.ToString(),
            MonthOfYear = recurring.RecurrencePatternValue.MonthOfYear,
