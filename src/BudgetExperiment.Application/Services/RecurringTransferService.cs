...
public sealed class RecurringTransferService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var sourceTransactions = await this._transactionRepository.GetByDateRangeAsync(fromDate, toDate, recurring.SourceAccountId, cancellationToken);
        ...
        var destTransactions = await this._transactionRepository.GetByDateRangeAsync(fromDate, toDate, recurring.DestinationAccountId, cancellationToken);
