// <copyright file="TransferActionParser.cs" company="BecauseImClever">
...
/// <summary>
/// Parses the <c>transfer</c> intent from an AI response data element
/// into a <see cref="CreateTransferAction"/>.
/// </summary>
internal static class TransferActionParser
{
    /// <summary>
    /// Builds a <see cref="CreateTransferAction"/> from the data element, resolving accounts by name.
    /// </summary>
    ...
    /// <param name="context">Optional chat context with date defaults.</param>
    /// <returns>The constructed action, or <c>null</c> if either account cannot be resolved.</returns>
    internal static CreateTransferAction? Parse(
        JsonElement data,
