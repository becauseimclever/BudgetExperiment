// <copyright file="TransactionLocationDto.cs" company="BecauseImClever">
...
/// <summary>
/// DTO for returning transaction location data.
/// </summary>
public sealed class TransactionLocationDto
{
    ...
    /// <summary>Gets or sets the source that determined this location (Manual, Gps, Parsed, Geocoded).</summary>
