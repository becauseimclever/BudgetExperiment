...
public sealed class CalendarGridDto
{
    ...
    /// </summary>
    public IReadOnlyDictionary<int, KakeiboBreakdownDto> WeekKakeiboBreakdowns { get; set; } = new Dictionary<int, KakeiboBreakdownDto>();
}
