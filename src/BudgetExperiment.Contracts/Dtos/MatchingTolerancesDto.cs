...
public sealed record MatchingTolerancesDto
{
    ...
    /// <summary>
    /// Gets the maximum percentage variance in amount (0.0 to 1.0).
    /// </summary>
    public decimal AmountTolerancePercent { get; init; } = 0.10m;

    /// <summary>
    /// Gets the maximum absolute amount variance.
    /// </summary>
    public decimal AmountToleranceAbsolute { get; init; } = 10.00m;

    /// <summary>
    /// Gets the minimum description similarity threshold (0.0 to 1.0).
    /// </summary>
    public decimal DescriptionSimilarityThreshold { get; init; } = 0.6m;

    /// <summary>
    /// Gets the minimum confidence for auto-matching (0.0 to 1.0).
    /// </summary>
