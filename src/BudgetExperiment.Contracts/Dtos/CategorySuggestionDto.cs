...
public sealed record CategorySuggestionDto
{
    ...
    /// </summary>
    public required string SuggestedName
    {
        get; init;
    }
    ...
    /// </summary>
    public required string SuggestedType
    {
        get; init;
    }
    ...
    /// </summary>
    public required decimal Confidence
    {
        get; init;
    }
    ...
    /// </summary>
    public required IReadOnlyList<string> MerchantPatterns
    {
        get; init;
    }
