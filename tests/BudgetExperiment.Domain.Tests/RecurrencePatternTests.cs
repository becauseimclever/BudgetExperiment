...
/// <summary>
/// Tests for <see cref="RecurrencePatternValue"/> value object.
/// </summary>
public class RecurrencePatternTests
{
    ...
    {
        var pattern = RecurrencePatternValue.CreateDaily(1);
    ...
    {
        var pattern = RecurrencePatternValue.CreateDaily(3);
    ...
    {
        var ex = Assert.Throws<DomainException>(() => RecurrencePatternValue.CreateDaily(interval));
    ...
    {
        var pattern = RecurrencePatternValue.CreateWeekly(1, DayOfWeek.Monday);
    ...
    {
        var pattern = RecurrencePatternValue.CreateBiWeekly(DayOfWeek.Friday);
    ...
    {
        var ex = Assert.Throws<DomainException>(() => RecurrencePatternValue.CreateMonthly(1, dayOfMonth));
    ...
    {
        var pattern = RecurrencePatternValue.CreateQuarterly(1);
    ...
    {
        var pattern = RecurrencePatternValue.CreateYearly(15, 6);
    ...
    {
        var ex = Assert.Throws<DomainException>(() => RecurrencePatternValue.CreateYearly(15, monthOfYear));
    ...
    {
        var pattern1 = RecurrencePatternValue.CreateMonthly(1, 15);
        var pattern2 = RecurrencePatternValue.CreateMonthly(1, 15);
    ...
    {
        var pattern1 = RecurrencePatternValue.CreateMonthly(1, 15);
        var pattern2 = RecurrencePatternValue.CreateMonthly(1, 20);
    ...
    {
        var pattern = RecurrencePatternValue.CreateWeekly(1, DayOfWeek.Friday);
    ...
    {
        var pattern = RecurrencePatternValue.CreateMonthly(1, 31);
    ...
    {
        var pattern = RecurrencePatternValue.CreateYearly(29, 2);
