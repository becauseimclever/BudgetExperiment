...
/// <summary>
/// Unit tests for the <see cref="PaycheckAllocationValue"/> value object.
/// </summary>
public class PaycheckAllocationTests
{
    ...
    public void Create_WithValidInputs_CreatesAllocation()
    {
        ...
        // Act
        var allocation = PaycheckAllocationValue.Create(bill, amountPerPaycheck, annualAmount);
    ...
    public void Create_WithNullBill_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(
            () => PaycheckAllocationValue.Create(null!, amountPerPaycheck, annualAmount));
    }
    ...
    public void Create_WithNullAmountPerPaycheck_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(
            () => PaycheckAllocationValue.Create(bill, null!, annualAmount));
    }
    ...
    public void Create_WithNullAnnualAmount_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(
            () => PaycheckAllocationValue.Create(bill, amountPerPaycheck, null!));
    }
    ...
    public void Allocation_RecordEquality_WorksCorrectly()
    {
        ...
        var allocation1 = PaycheckAllocationValue.Create(bill, amountPerPaycheck, annualAmount);
        var allocation2 = PaycheckAllocationValue.Create(bill, amountPerPaycheck, annualAmount);
    ...
    {
        // Arrange
        var bill1 = BillInfoValue.Create("Rent", MoneyValue.Create("USD", 1200m), RecurrenceFrequency.Monthly);
        var bill2 = BillInfoValue.Create("Insurance", MoneyValue.Create("USD", 600m), RecurrenceFrequency.Quarterly);
        var amountPerPaycheck = MoneyValue.Create("USD", 553.85m);
        var annualAmount = MoneyValue.Create("USD", 14400m);

        var allocation1 = PaycheckAllocationValue.Create(bill1, amountPerPaycheck, annualAmount);
        var allocation2 = PaycheckAllocationValue.Create(bill2, amountPerPaycheck, annualAmount);
