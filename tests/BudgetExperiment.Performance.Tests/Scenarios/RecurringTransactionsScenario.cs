...
/// <summary>
/// NBomber scenario for the <c>GET /api/v1/recurring-transactions</c> endpoint.
/// </summary>
public static class RecurringTransactionsScenario
{
    /// <summary>The scenario name used in reports and threshold references.</summary>
    public const string Name = "get_recurring_transactions";

    /// <summary>
    /// Creates the recurring transactions GET scenario with the specified load simulations.
    /// </summary>
    ...
    public static ScenarioProps Create(HttpClient client, params LoadSimulation[] loadSimulations)
    {
        ...
        {
            var request = Http.CreateRequest("GET", "/api/v1/recurring-transactions");
