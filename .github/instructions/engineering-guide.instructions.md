---
description: "Use when planning, implementing, reviewing, or testing changes in this repository. Defines architecture, coding standards, testing, API, deployment, and documentation rules."
...
- **Hardened Image Policy**:
  ...
  - **PostgreSQL**: Use Docker Hardened Image (`dhi.io/postgres:18`) — continuously patched, SLSA provenance, drop-in replacement.
